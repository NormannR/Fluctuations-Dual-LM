...
@everywhere begin
    ...
    include("SMCfunctions_habits.jl")
    # include("IskrevFunctions.jl")
    include("input\\InitialGuess_habits.jl")
...
JLD.save("LT_SHORT_habits.jld","theta",drawsMat[Nphi,:,:],"weights",weightsMat[:,Nphi],"loglh",loglh,"logpost",logpost,"constMat",constMat)


# JLD.save("LT_SHORT.jld","theta",drawsMat[Nphi,:,:],"weights",weightsMat[:,Nphi],"loglh",loglh,"logpost",logpost,"constMat",constMat)
# JLD.save("LONG_habits.jld","theta",drawsMat[Nphi,:,:],"weights",weightsMat[:,Nphi],"loglh",loglh,"logpost",logpost,"constMat",constMat)
