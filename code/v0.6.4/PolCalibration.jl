...
# cd("C:\\Users\\Normann\\Dropbox\\Ch2\\code\\23_02_2019_Euro\\input")
...
# x0 = [0.460937 0.840553 1.09405 0.969132]
# x0 = [ 0.45845  0.840091  1.13772  0.953567 ]
results = nlsolve(f!, x0, show_trace = true, method = :trust_region, iterations = 20, ftol = eps())
x = results.zero
F = x[1]
b = x[2]
zf = x[3]
...
save("PolParameters.jld", "rho", rho, "sigma", sigma, "eta", eta, "m", m, "sigma_z",
